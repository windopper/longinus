...
//	private static final HashMap<Player, TutorialImproved> instance = new HashMap<>();
//	private final static List<Player> elevatordetect = new ArrayList<>();
//	
//	private Player p;
//	
//	public TutorialImproved(Player p) {
//		this.p = p;
//	}
//	
//	public static TutorialImproved getinstance(Player p) {
//		if(!instance.containsKey(p)) {
//			instance.put(p, new TutorialImproved(p));
//		}
//		return instance.get(p);
//	}
//	
//	private int jumpfail = 0;
//	private int trainerbothit = 0;
//	private int examset = 0;
//	private int[] exambothit = new int[30];
//	private int exambothitcount = 0;
//	private int time = 0;
//	private int SCORE = 0;
//	private int GRADE = 0;
//	
//	public static Set<Player> getinstanceKeySet() {
